...
export function HomePage() {
  ...
  return (
    <div className="">
      <Navbar />
      <main className="flex w-auto flex-1 items-center justify-center pb-24 pt-2 ">
        <div className="container flex flex-col items-center justify-center gap-4 px-4 md:px-6">
          ...
          <div className="text-center">
            <p className="max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl">
              Créer un exercice, puis fait ta séance.{" "}
            </p>
          </div>
          <div className="flex w-screen flex-col justify-around gap-2 px-4  ">
            <Link
            ...
            >
              <div className=" flex items-center gap-4 pl-4">
                ...
                <p className="tab tab-whishlist block text-sm dark:text-gray-900  ">
                  Créé un <span className=" font-bold"> exercice</span>, ajoute un temps de repos, des répétitions et un
                  conseil.
                </p>
              </div>
