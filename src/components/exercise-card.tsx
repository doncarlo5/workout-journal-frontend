...
function ExerciseCard({ exercise }: { exercise: any }) {
  return (
    <Link
      className="my-2 flex w-11/12 border justify-center rounded-2xl relative  bg-slate-100 px-3 py-2 shadow-md active:translate-y-0.5 active:shadow-none dark:bg-slate-900 dark:bg-opacity-40 md:text-lg"
    ...
    >
      <div className="">
        ...
        <ChevronRight className="absolute my-auto right-2 top-2" />
    </Link>
  )
}
