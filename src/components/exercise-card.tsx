...
function ExerciseCard({ exercise }: { exercise: any }) {
  return (
    <Link
      className="flex w-11/12 my-2 rounded-2xl justify-center  bg-slate-100 px-3 py-2 shadow-md active:translate-y-0.5 active:shadow-none md:text-lg dark:bg-slate-900 dark:bg-opacity-40"
