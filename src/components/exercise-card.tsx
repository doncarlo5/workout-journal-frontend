              ...
              <table className="w-full rounded-md text-left">
                <tbody className=" ">
                  <tr className=" bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td className="px-3 py-2 font-light tracking-tighter text-gray-700">{exercise.type.repRange1}</td>
                  </tr>
                  ...
                  <tr className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td className="px-3 py-2 font-light tracking-tighter text-gray-700">{exercise.type.repRange2}</td>
                  </tr>
                  ...
                  <tr className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <td className="px-3 py-2 font-light tracking-tighter text-gray-700">{exercise.type.repRange3}</td>
                  </tr>
                </tbody>
              </table>
            </div>
